...
var userName = 'Max'; /* in here we see JS code being written in a typescript file */
...
var userNamee; /* <= in here, the variable has been declared to accept any type and does not have an initial value. Therefore can hold a string type of an integer type of data*/
userNamee = 34;
...
var useerName; /* <= This is Typescript specific syntax || string is one of the built in types that Typescript supports */
